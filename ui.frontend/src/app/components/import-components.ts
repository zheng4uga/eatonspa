 ...
 */
MapTo('eatonspa/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('eatonspa/components/separator')(SeparatorV1Component);

MapTo('eatonspa/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('eatonspa/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('eatonspa/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('eatonspa/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('eatonspa/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('eatonspa/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('eatonspa/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('eatonspa/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('eatonspa/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('eatonspa/components/accordion')(AccordionV1Component);
MapTo('eatonspa/components/tabs')(TabsV1Component);
...
LazyMapTo('eatonspa/components/teaser')(TeaserV1Component);
...
LazyMapTo('eatonspa/components/carousel')(CarouselV1Component);
...
LazyMapTo('eatonspa/components/text')(LazyTextModule, TextEditConfig);